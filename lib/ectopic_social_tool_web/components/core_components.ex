defmodule EctopicSocialToolWeb.CoreComponents do
  @moduledoc """
  ...
  def input(%{type: "textarea"} = assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <textarea
        ...
        name={@name}
        class={[
          "mt-2 border-solid border-2 border-zinc-400 block w-full rounded-lg text-zinc-900  sm:text-sm sm:leading-6",
          "py-2 px-2 min-h-[6rem] phx-no-feedback:border-zinc-300 phx-no-feedback:focus:border-zinc-400",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(EctopicSocialToolWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(EctopicSocialToolWeb.Gettext, "errors", msg, opts)
    end
  end
